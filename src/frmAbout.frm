...
Begin VB.Form frmAbout 
   ...
   Caption         =   "Acerca del Conversor de Gráficos a Texto"
   ClientHeight    =   3555
   ClientLeft      =   2340
   ClientTop       =   1935
   ClientWidth     =   5940
   ...
   Begin VB.PictureBox PictureIsla 
      AutoSize        =   -1  'True
      BorderStyle     =   0  'None
      Height          =   480
      Left            =   240
   ...
   Begin VB.Label lblAutor 
      Caption         =   "By:  Antonio T. Márquez Muñoz"
      Height          =   255
      Left            =   1080
      TabIndex        =   7
      Top             =   1200
   ...
   Begin VB.Label lblDescription 
      Caption         =   "    Programa para la conversión de gráficos a textos de los usuarios autorizados."
      ForeColor       =   &H00000000&
      Height          =   570
      Left            =   1050
      TabIndex        =   3
   ...
   Begin VB.Label lblTitle 
      Caption         =   "Conversor de Gráficos a Texto"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   13.5
         Charset         =   0
...
Private Sub PictureIsla_Click()
    Unload Me

    Dim Isla As frmIsla
    Set Isla = New frmIsla
    Isla.Show vbModal
End Sub
